...
`analysis/united-states-1947/inert-manoeuvre.md` is the write-up. `./verify.sh` re-runs everything from scratch, including the slow lower-bound experiment: **102 checks, all passing**, on a clean checkout with Isabelle on PATH.
