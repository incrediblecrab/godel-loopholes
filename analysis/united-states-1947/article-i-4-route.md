...
Reinforcing the scope, and the single most important statutory fact for this route: the Apportionment Act of August 8, 1911 (37 Stat. 13, ch. 5) prescribed explicit districting standards. Section 3, read from the Library of Congress page image at 37 Stat. 14:
...
Section 4 of the same act provided that where a state gained seats, the additional representatives were elected at large until the state redistricted.

The Permanent Apportionment Act of June 18, 1929 (46 Stat. 21, ch. 28) contains no such requirement. Section 22, read from the page image at 46 Stat. 26, directs the President to transmit apportionment statements and provides a fallback if Congress fails to act. There is no contiguity, compactness, or equal-population language anywhere in it. *Wood v. Broom*, 287 U.S. 1 (1932), confirmed that the 1911 standards did not carry forward: they "related only to the districts to be formed under that Act, and were not reenacted in the Reapportionment Act of June 18, 1929."

**In 1947 there are no federal standards for how congressional districts are drawn.** Congress possessed the power, actually exercised it in 1911, and then withdrew the standards in 1929 while keeping the power to prescribe them. The withdrawal is verified from both statutes and judicially confirmed. That combination — power retained, standards withdrawn — is the reason this route has a live silence to operate in rather than a rule to break, and it is the convergence that makes the route's congressional stage survive.

The convergence must be stated in both directions. It is the strongest version of the route: Congress proved in 1911 that it could prescribe district standards under Article I §4, and in 1929 proved it could withdraw them, and *Wood v. Broom* confirmed the withdrawal was effective, and *Colegrove v. Green* confirmed no court would police the resulting districts. Every link in that chain is settled law on the 1947 vantage. But it is also where overclaiming is most dangerous: a power to set district standards is still a power exercised "by Law" with presentment, and any statute enacted under it still has to beat 179 without the President or cost only 135 with the President. The power to set unfair rules is not the same as the power to determine outcomes. That gap — between legal authority and electoral result — is Step 3, and it remains the route's weak step.
...
**Statutory history, page-image-verified.** The Apportionment Act of August 8, 1911 (37 Stat. 13, ch. 5), section 3, was read from the Library of Congress page image at 37 Stat. 14. The section 3 text quoted above under Step 2's legal status is from that page image. The Permanent Apportionment Act of June 18, 1929 (46 Stat. 21, ch. 28), section 22, was read from the page image at 46 Stat. 26. `silence-inventory.md` independently verifies the same from both sides; the page-image readings here are a separate verification, not a citation of that file.

**How to reproduce those two readings.** Volume 37 is `https://tile.loc.gov/storage-services/service/ll/llsl//llsl-c62/llsl-c62.pdf` and volume 46 is `https://tile.loc.gov/storage-services/service/ll/llsl//llsl-c71/llsl-c71.pdf`. Both were confirmed to be the intended volumes by reading the title the loc.gov JSON API returns, because the identifiers are keyed to Congress and session rather than to volume number: `llsl-c62` reports "Volume 37 (1911-1913), 62nd Congress" and `llsl-c71` reports "Volume 46 (1929-1931), 71st Congress." The statute page is not the PDF page. 37 Stat. 14 is PDF page 37 and 46 Stat. 26 is PDF page 70, and both offsets were established by rendering a page and reading its printed folio rather than by assuming a constant. Render with `pdftoppm -f <page> -l <page> -r 200 -png`, then look at the image.

**The 1929 Act's silence is an absence claim, and it was tested as one.** Searching the text layer of the whole Act (46 Stat. 21-27, PDF pages 65-71) for *contiguous*, *compact*, *equal number of inhabitants* and *districts composed* returns nothing. That search was positive-controlled against the 1911 Act, where the identical search returns four hits, so the search demonstrably works and the null is a real null rather than a broken query. The text layer is sufficient for this one purpose: an absence claim about four distinctive content words does not turn on punctuation, which is the thing optical character recognition actually destroys. The quoted section 3 text, which does turn on punctuation, was taken from the rendered image and not from the text layer.

**Case law NOT read from page images, and the honest reason.** The holdings listed above under "Case law NOT read from page images by this analysis" remain unverified against Library of Congress scans. An earlier draft of this file explained that gap by asserting that the LOC PDFs "could not be rendered to readable images in this session." That explanation was false, and it sat in the same file as two claims of page-image verification, which should have been caught before it was written. LOC PDFs render fine, as the two statutory readings above now demonstrate. The case law is unverified because it was not done, not because it could not be done. The distinction matters: the first is a task remaining, the second would have been a reason to stop trying.
